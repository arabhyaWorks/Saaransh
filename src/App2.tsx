    ...
    if (editorRef.current.scrollHeight > PAGE_HEIGHT) {
      ...
      setTimeout(() => {
        if (editorRef.current) {
          editorRef.current.innerHTML = firstPageContent;
        }
      }, 0);
    } else {
      setPages(newPages);
          ...
          {pages.map((pageContent, index) => (
            ...
            >
              ...
              <div
                ...
                onInput={index === pages.length - 1 ? handleInput : undefined}
                ...
                dangerouslySetInnerHTML={{ __html: index !== pages.length-1 ? pageContent : undefined }}
              />
            </div>
          ))}
        </div>
